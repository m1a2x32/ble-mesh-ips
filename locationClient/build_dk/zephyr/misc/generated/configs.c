...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYS_CLOCK_TICKS_PER_SEC, 250);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_LOC_SRV, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_ADV_STACK_SIZE, 4096);
